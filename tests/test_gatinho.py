...
def test_not_cat_2_predict():

    with open("tests/notcat2.jpg", "rb") as f:
        img_bytes = f.read()       
...
def test_not_cat_3_predict():

    with open("tests/notcat3.jpg", "rb") as f:
        img_bytes = f.read()       
...
def test_not_cat_4_predict():

    with open("tests/notcat4.jpg", "rb") as f:
        img_bytes = f.read()       
